...
results = load_results('./results/001_stuck.pkl')
...
circle1 = Circle((5, 9.25), 1, alpha=0.5)  
circle2 = Circle((8, 9), 0.5, alpha=0.5) # (2.5 , 9.25) >> turn_case_study, (2, 9.25) >>  001_turn_case_study
